  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 max-w-7xl mx-auto">
        <div className="text-center">          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 drop-shadow-sm">
            Poketmon
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Your ultimate resource for the original 151 Poketmon. Build teams, explore, 
        ...
        <div className="mt-12">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Create and customize your perfect Poketmon team composition with our interactive builder.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
